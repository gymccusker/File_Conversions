...
# info2 = ' Parametrization derived from ACCACIA 2DS ice number concentration measurements used for primary ice nucleation (see Young et al., 2017 (ACP) for details). Model assumes oceanic surface.'
